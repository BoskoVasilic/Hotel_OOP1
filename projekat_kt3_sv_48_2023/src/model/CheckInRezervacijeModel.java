...
public class CheckInRezervacijeModel extends AbstractTableModel {
	private static final long serialVersionUID = -3229278871567689559L;
	...
	public CheckInRezervacijeModel(RezervacijaManager rm) {
		this.rm = rm;
	}
	
	@Override
	public int getRowCount() {
		return rm.getPotvrdjeneRezervacije().size();
	}
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		if (rowIndex >= rm.getPotvrdjeneRezervacije().size()) {
			switch (columnIndex) {
			case 0:
				return "";
			case 1:
		...
		Rezervacija r = rm.getPotvrdjeneRezervacije().get(rowIndex);
		switch (columnIndex) {
		case 0:
			return r.getId();
		case 1:
